...
def freebase_params():
    ...
    parser.add_argument('--feat_mask', type=float, default=0.9)
    parser.add_argument('--adj_mask', type=float, nargs='+', default=[0.2, 0.5, 0.5])
    parser.add_argument('--nei_max', type=int, nargs='+', default=[70, 120, 60])
    parser.add_argument('--num_cluster', nargs='+', default=[100, 600], type=int, help='number of clusters')
    parser.add_argument('--lam_proto', type=float, default=1)
